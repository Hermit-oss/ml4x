...
public class HexMapGenerator : MonoBehaviour
{
	...
	struct Biome
	{
		public int terrain, wood, stone;

		public Biome(int terrain, int wood, int stone)
		{
	...
	static readonly Biome[] biomes = {
		new(0, 0, 0), new(4, 0, 1), new(4, 0, 2), new(4, 0, 3),
		new(0, 0, 0), new(2, 0, 1), new(2, 1, 1), new(2, 2, 0),
		new(0, 0, 0), new(1, 0, 1), new(1, 1, 0), new(1, 2, 0),
		new(0, 0, 0), new(1, 1, 0), new(1, 2, 0), new(1, 3, 0)
	};
	...
	void SetTerrainType()
	{
		...
		for (int i = 0; i < cellCount; i++)
		{
			...
			if (!cell.IsUnderwater)
			{
				...
				if(cellBiome.terrain == 2)
				{
					cellBiome.wood = 0;
					if (cellBiome.stone < 3)
					{
                        cellBiome.stone += 1;
                    }
				}
				...
				else if (cellBiome.wood < 3 && cellBiome.stone < 3 && cell.HasRiver)
				{
					cellBiome.wood += 1;
					cellBiome.stone += 1;
				}
				grid.CellData[i].values = cell.values.
					...
					WithStoneLevel(cellBiome.stone).
					WithWoodLevel(cellBiome.wood);
			}
			else
			{
				int terrain;
